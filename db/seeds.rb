...
Flight.create!(
  [
    ...
    { departure_airport: airports[0], arrival_airport: airports[1], start: Time.now + 1.days, flight_duration: 150 },
    ...
    { departure_airport: airports[3], arrival_airport: airports[4], start: Time.now + 4.days, flight_duration: 240 },
